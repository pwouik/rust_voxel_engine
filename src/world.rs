...
impl World {
    ...
    pub fn update_display(&mut self, renderer: &mut Renderer) {
        ...
        for pos in positions {
            if self.chunk_map.get_chunk(pos).is_some() {
                ...
                renderer
                    .chunk_renderer
                    .add_chunk(pos, &mut self.create_mesh(pos), &renderer.queue);
            }
        }
    }
    #[profiling::function]
    fn add_face(
        ...
        let global_pos =
            point3(chunk_pos.x << 5, chunk_pos.y << 5, chunk_pos.z << 5) + pos.to_vec();
        let ao_blocks = [
            self.chunk_map
                .get_block(global_pos + dir.transform(vec3(1, 1, 0)))
                .is_full_block(),
            self.chunk_map
                .get_block(global_pos + dir.transform(vec3(1, 1, 1)))
                .is_full_block(),
            self.chunk_map
                .get_block(global_pos + dir.transform(vec3(0, 1, 1)))
                .is_full_block(),
            self.chunk_map
                .get_block(global_pos + dir.transform(vec3(-1, 1, 1)))
                .is_full_block(),
                ...
                for x in 0..32 {
                    ...
                    if b1 != b2 {
                        if b1 == true {
                            self.add_face(
                                &mut storage,
                                point3(x as i32, y as i32, z as i32),
                                pos,
                                Direction { id: 1 },
                            ...
                            self.add_face(
                                &mut storage,
                                point3((x + 1) as i32, y as i32, z as i32),
                                pos,
                                Direction { id: 0 },
                    ...
                    if b1 != b2 {
                        if b1 == true {
                            ...
                            self.add_face(
                                &mut storage,
                                point3(x as i32, y as i32, (z + 1) as i32),
                                pos,
                                Direction { id: 2 },
                    ...
                    if b1 != b2 {
                        if b1 == true {
                            ...
                            self.add_face(
                                &mut storage,
                                point3(x as i32, (y + 1) as i32, z as i32),
                                pos,
                                Direction { id: 4 },
